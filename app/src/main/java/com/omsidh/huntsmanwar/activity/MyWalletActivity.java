...
import com.omsidh.huntsmanwar.fragment.AddCoinsFragment;
import com.omsidh.huntsmanwar.fragment.RedeemCoinsFragment;
import com.omsidh.huntsmanwar.fragment.TransactionsFragment;
import com.omsidh.huntsmanwar.paytm.Api;
import com.omsidh.huntsmanwar.paytm.Checksum;
import com.omsidh.huntsmanwar.paytm.Paytm;
...
public class MyWalletActivity extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    private String walletSt, statusSt, orderIdSt, txnIdSt, amountSt, coinSt, remarkSt, modeSt, currencySt, is_active;
    ...
    private String UPI_PACKAGE_NAME = "net.one97.paytm";
...
//                        parameters.put("mobile", mobileNumber);
    ...
    private void createViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AddCoinsFragment(), "ADD COIN");
        adapter.addFragment(new RedeemCoinsFragment(), "REDEEM COIN");
        adapter.addFragment(new TransactionsFragment(), "TRANSACTION");
    ...
    public void Add(String title, String subtitle, String message, String amount, String coins, String id, String status, String image, String mode, String currency) {
        ...
        if (walletSt.equalsIgnoreCase("PayTm")) {
            ...
            remarkSt = "Added From PayTm UPI";
            payUsingUpi(amount, Config.UPI_ID, name, "Added From PayTm UPI");
        }
        else if (walletSt.equalsIgnoreCase("Gift Card")) {
            Intent intent = new Intent(this,GiftCardActivity.class);
            startActivity(intent);
        }
        else {
            Intent intent = new Intent(this,PaymentVerifictionActivity.class);
    ...
    private void generateCheckSum(String amount) {
        ...
        //creating link call object from the apiService
    ...
    private void initializePaytmPayment(String checksumHash, Paytm paytm) {
        ...
        //creating link hashmap and adding all the values required
        ...
        //creating link button_paytm order object using the hashmap
...
*/
        ...
        if(null != intent.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(MyWalletActivity.this,"PayTm app not found, please install one to continue",Toast.LENGTH_SHORT).show();
        }
    }
...
*/
    ...
    private void sendPaymentDetails() {
        ...
        // Request link string response from the provided URL.
                ...
                if (requestCode == REQUEST_CODE) {
                    if (resultCode == Activity.RESULT_OK) {
                        ...
                        if (!amountSt.isEmpty()) {
                            ...
                            Toast.makeText(MyWalletActivity.this, "Please enter link valid amount.", Toast.LENGTH_SHORT).show();
